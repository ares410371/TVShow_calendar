class TvShowsController < ApplicationController
  ...
  private
    ...
    def tv_show_params
      params.require(:tv_show).permit(:tv_show_internal, :name, :overview, :poster_path, :backdrop_path, :number_of_seasons, :number_of_episodes, :original_language, :homepage, :first_air_date, :last_air_date, :episode_run_time, :vote_average, :status)
    end
end
